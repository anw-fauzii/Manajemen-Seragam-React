...
const ModalDetailPesanan = ({ modalData, closeModal }) => {
    const updateStatus = (id) => {
        router.post(`/edit-pesanan/${id}`);
        toastr.success('Pesanan Berhasil Diselesaikan', 'Sukses!');
    }
                        ...
                        <div className="w-full max-w-2xl">
                            <div className="bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                {modalData.pesanan_detail.map((data, i) => (
                                                    <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                        ...
                                                        <td className="px-6 py-4">
                                                            {data.seragam_detail.seragam.nama_seragam} <strong>({data.seragam_detail.ukuran})</strong>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            {data.jumlah}
                                                        </td>
                                ...
                                <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                    {modalData.status == 0 ?
                                        <button
                                            onClick={() => { updateStatus(modalData.id); closeModal() }}
                                            type="button"
