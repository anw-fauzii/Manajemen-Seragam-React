                                    ...
                                    <div className="flex overflow-x-auto  p-3">
                                        ...
                                        <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            {modalData.seragam_details.map((data, i) => {
                                                return (<option value={data.ukuran}>{data.ukuran}</option>)
                                            })}
                                        </select>
                                    </div>
                                    <div className="flex overflow-x-auto p-3">
                                        <label for="harga" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white mr-16 mt-2">Qty</label>
                                        <input type="number" min="1" onChange={(e) => setData('stok', e.target.value)} id="stok" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={data.stok} />
