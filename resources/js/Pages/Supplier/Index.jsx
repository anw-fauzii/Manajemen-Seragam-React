...
export default function Index(props) {
    ...
    const filteredItems = props.supplier.data.filter(
        item =>
    ...
    const columns = [
        ...
        { name: 'Nama supplier', selector: row => row.nama_supplier, sortable: true, width: '20%' },
        { name: 'Penanggung Jawab', selector: row => row.penanggung_jawab, sortable: true, width: '15%' },
        { name: 'Alamat', selector: row => row.alamat, sortable: true, width: '20%' },
        { name: 'Telepon', selector: row => row.telepon, sortable: true, width: '15%' },
        {
            name: 'Edit | Info | Hapus',
            cell: (row) => (
                <div className="flex justify-center">
                    <Link replace href={route('supplier.edit', row.id)}>
    ...
    const handleInfoClick = (id) => {
        const selectedData = props.supplier.data.find(item => item.id === id);
    ...
    return (
        <div>
            ...
            <div className="p-4 sm:ml-64 mt-16">
                <JudulHeader judul={props.title} subJudul="Supplier" />
                <Modal />
                <div className="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <DataTable
                        ...
                        paginationTotalRows={props.supplier.total}
