    ...
    const subHeaderComponentMemo = useMemo(() => {
        return (
            <div className=' flex justify-between min-w-full'>
                <div className='flex'>
                    <Link replace href={route('perhitungan-harga-seragam.create')}>
        ...
        { name: 'Keuntungan', selector: row => row.keuntungan + " %", sortable: true, width: '12%' },
        {
            ...
            cell: (row) => (
                <div className="flex justify-center">
                    <Link replace href={route('perhitungan-harga-seragam.edit', row.id)}>
            ...
            <div className="p-4 sm:ml-64 mt-16">
                ...
                <div className="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <DataTable
                        ...
                        paginationTotalRows={props.HargaDasar.total}
